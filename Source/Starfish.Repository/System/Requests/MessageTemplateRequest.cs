...
public record MessageTemplateListQuery(string Code, MessageTemplateType? Type, string Keyword, int Skip, int Size) : IRequest<IList<MessageTemplateListModel>>;
...
/// null or empty to ignore this filter.</param>
public record MessageTemplateCountQuery(string Code, MessageTemplateType? Type, string Keyword) : IRequest<int>;
...
public record MessageTemplateMatchQuery(string Code, MessageTemplateType Type, string Language) : IRequest<MessageTemplateDetailModel>;