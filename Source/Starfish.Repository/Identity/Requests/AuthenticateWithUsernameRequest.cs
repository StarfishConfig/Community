...
/// Implements <see cref="IRequest{UserAuthQueryModel}"/> and expects a <see cref="AuthInfoModel"/> result on success.
/// </summary>
...
public record AuthenticateWithUsernameRequest(string Username, string Password) : IRequest<AuthInfoModel>;