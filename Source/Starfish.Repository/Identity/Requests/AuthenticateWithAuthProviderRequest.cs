...
/// <see cref="UserAuthQueryModel"/> on successful authentication.
/// </summary>
...
public record AuthenticateWithAuthProviderRequest(string Provider, string OpenId) : IRequest<UserAuthQueryModel>;